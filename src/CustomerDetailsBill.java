...
public class CustomerDetailsBill extends javax.swing.JFrame {
    ...
    public CustomerDetailsBill() {
        ...
        jtxtSearch.setText(myFormat.format(cal.getTime()));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 36, 259, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1225, 6, 23, 23));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Search By Check Out Date");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(312, 117, 200, -1));

        jtxtSearch.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(jtxtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(517, 114, 301, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(872, 114, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 154, 1231, 340));

        jLabel5.setFont(new java.awt.Font("Algerian", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(102, 0, 0));
        jLabel5.setText("CLICK ON TABLE ROW TO OPEN BILL");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(402, 516, 421, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String checkoutDate = jtxtSearch.getText();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            if (new File("E:\\" + id + ".pdf").exists()) {
                ...
                JOptionPane.showMessageDialog(null, "Filw is not exist");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
